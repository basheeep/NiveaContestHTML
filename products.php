      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2">Some of our Selling Products</span></p>
          </div>
        </div>
      </div>
    </div>
    		...
    		<div class="row">
    			<div class="col-sm col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 px-3">
    						<h3><a href="#">Nivea Creme Care</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc">RM42.00</span><span class="price-sale">RM32.00</span></p>
		    					</div>
		    					<div class="rating">
	    							<p class="text-right">
    			...
    			<div class="col-sm col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 px-3">
    						<h3><a href="#">Nivea Creme Smooth </a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>RM22.00</span></p>
		    					</div>
		    					<div class="rating">
	    							<p class="text-right">
	    								<span class="ion-ios-star-outline"></span>
    			...
    			<div class="col-sm col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 px-3">
    						<h3><a href="#">Nivea Hand Lotion</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>RM27.00</span></p>
		    					</div>
		    					<div class="rating">
	    							<p class="text-right">
	    								<span class="ion-ios-star-outline"></span>
    			...
    			<div class="col-sm col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 px-3">
    						<h3><a href="#">Nivea Body Lotion</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>RM32.00</span></p>
		    					</div>
		    					<div class="rating">
	    							<p class="text-right">
	    								<span class="ion-ios-star-outline"></span>
    			...
    			<div class="col-sm col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/product-1.png" alt="Colorlib Template"></a>
    					<div class="text py-3 px-3">
    						<h3><a href="#">Nivea Creme Care</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
    			...
    			<div class="col-sm col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/product-2.png" alt="Colorlib Template"></a>
    					<div class="text py-3 px-3">
    						<h3><a href="#">Nivea Creme Smooth</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
    			...
    			<div class="col-sm col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					...
    					<div class="text py-3 px-3">
    						...
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span>RM33.00</span></p>
		    					</div>
		    					<div class="rating">
	    							<p class="text-right">
	    								<span class="ion-ios-star-outline"></span>
